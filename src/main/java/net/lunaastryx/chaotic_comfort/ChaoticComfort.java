...
@Mod(ChaoticComfort.MOD_ID)
public class ChaoticComfort {
    ...
    public ChaoticComfort(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = ChaoticComfort.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
